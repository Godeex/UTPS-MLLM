...
# internvl.train.trainer -> trainer_v_1
# --------------------------------------------------------
...
IGNORE_INDEX = -100
Image.MAX_IMAGE_PIXELS = None  # 取消图像像素限制
ImageFile.LOAD_TRUNCATED_IMAGES = True  # 允许加载截断的图像
MaximumDecompressedSize = 1024
MegaByte = 2**20
PngImagePlugin.MAX_TEXT_CHUNK = MaximumDecompressedSize * MegaByte  # 设置PNG文本块大小限制
...
def main():
    ...
    # 如果使用packed dataset，替换注意力类以优化性能
    ...
    logger.info("D-MoLE Config Complete")  #
    ...
    if training_args.do_train:
        ...
        # 对于顺序LoRA微调，在每个任务训练后需要合并LoRA权重
        # 但D-MoLE方法不需要合并，因为需要保留任务特定的专家
